...
jQuery( '#contactForm' ).on('submit_success', function(){
	dataLayer.push({'event' : 'contact'})
});

jQuery('.mlw_horizontal_multiple input').on('click', function(){       
	jQuery(this).closest('.mlw_horizontal_multiple').toggleClass("active");
});

jQuery('#main #content-wrap h2').prev().css('margin-bottom', '0px');
jQuery('#main #content-wrap h3').prev().css('margin-bottom', '0px');

jQuery('.entry-content .spoiler-item').parent('p').css('margin-bottom', '0px');
jQuery('.entry-content .spoiler-item').parent('h3').css('padding', '0px');
jQuery('.entry-content .spoiler-item').on('click', function(){
	jQuery(this).next('.spoiler-content').toggleClass("active");
