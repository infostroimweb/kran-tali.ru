...
class Widget_Social_Icons extends Widget_Base {
	...
	protected function render() {
		...
		?>
		<a href="#" class="jsModalOpen elementor-button-link elementor-button elementor-size-md" role="button" data-id-modal="callback">
			<span class="elementor-button-content-wrapper">
				<span class="elementor-button-text">ЗАКАЖИТЕ ЗВОНОК</span>
			</span>
		</a>
		<?php
	}
